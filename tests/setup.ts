...
vi.mock('lucide-react', () => ({
  ...
  ArrowDown: ({ className, ...props }: any) => React.createElement('div', { 'data-testid': 'arrow-down-icon', className, ...props }),
  RefreshCw: ({ className, ...props }: any) => React.createElement('div', { 'data-testid': 'refresh-icon', className, ...props }),
  Wifi: ({ className, ...props }: any) => React.createElement('div', { 'data-testid': 'wifi-icon', className, ...props }),
...
vi.mock('@/components/ui/textarea', () => ({
  Textarea: React.forwardRef(({ className, onChange, onKeyDown, value, placeholder, disabled, ...props }: any, ref: any) => 
