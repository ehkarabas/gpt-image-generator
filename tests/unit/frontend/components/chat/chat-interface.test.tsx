...
vi.mock('@/components/chat/chat-input', () => ({
  ChatInput: ({ onSend }: any) => (
    <div data-testid="chat-input-mock">
      <button onClick={() => onSend?.('test message')} data-testid="mock-send-button">
        Send Test Message
      </button>
    </div>
  )
...
describe('ChatInterface', () => {
  ...
  it('renders welcome message when no messages exist', () => {
    ...
    expect(screen.getByText(/welcome to gpt image generator/i)).toBeInTheDocument()
  })
  ...
  it('hides welcome message when messages exist', () => {
    ...
    expect(screen.queryByTestId('chat-welcome-message')).not.toBeInTheDocument()
  })
